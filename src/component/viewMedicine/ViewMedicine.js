...
function ViewMedicine() { 
    ...
    const onEditMedicine = (e) =>{
        ...
        axios.post(`https://medicalstore.mashupstack.com/api/medicine/${medid}`,postdata, {
            headers: {
                Authorization: `Bearer ${token}`
            }
        }).then(response =>{
        ...
        <div>
            ...
            <div className="card card-view card-box">
                <div className="card-body">
                    <h5 className="card-title">Edit Medicine</h5>
                    <form>
                        <div className="mb-3">
                    ...
                    <button type="submit" className="btn btn-secondary" >Back</button>
                        ...
                        <button type="submit" className="btn btn-success" onClick={onEditMedicine}>Submit</button>
                        </div>
                    </form>
                </div>
            </div>
